...
public class Program
{
    public static void Main(string[] args)
    {
        try
        {
            ...
            for (int i = 0; i < 1000000; i++) // Loop besar untuk mempercepat overflow
            {
                video.IncreasePlayCount(10000000); // Tes overflow
            }
        ...
        Console.ReadLine(); // Mencegah jendela konsol langsung tertutup
    }
}
